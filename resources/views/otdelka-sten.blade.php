...
@section('title', 'Поклейка обоев, выравнивание стен, возведение перегородок в Томске')
@section('description', 'Заказать поклейку обоев в Томске или ремонт стен, а так же покраску и возведение перегородок. Тел: 89528052426')
@section('keywords', '')
@section('canonical', 'https://prorab70.ru/otdelka-sten')
@section('og:title', 'Поклейка обоев, выравнивание стен, возведение перегородок в Томске')
@section('og:description', 'Заказать поклейку обоев в Томске или ремонт стен, а так же покраску и возведение перегородок. Тел: 89528052426')
@section('og:url', 'https://prorab70.ru/otdelka-sten')
@section('twitter:title', 'Поклейка обоев, выравнивание стен, возведение перегородок в Томске')
@section('twitter:description', 'Заказать поклейку обоев в Томске или ремонт стен, а так же покраску и возведение перегородок. Тел: 89528052426')
...
@section('content')
    ...
    @component('components.breadcrumb')
        @slot('title') Отделка стен @endslot


        @slot('parent') Главная @endslot
{{--        @slot('prev') Предыдущая @endslot--}}

        @slot('active') Отделка стен @endslot
        @slot('activelink') {{ url('/otdelka-sten') }} @endslot
