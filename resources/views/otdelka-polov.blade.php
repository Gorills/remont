...
@section('description', 'Постелить линолеум, положить ламинат, паркет или залить стяжку - Прораб70. Тел: 89528052426')
...
@section('og:description', 'Постелить линолеум, положить ламинат, паркет или залить стяжку - Прораб70. Тел: 89528052426')
...
@section('twitter:description', 'Постелить линолеум, положить ламинат, паркет или залить стяжку - Прораб70. Тел: 89528052426')
...
@section('content')
    ...
    @component('components.breadcrumb')
        @slot('title') Отделка полов @endslot
